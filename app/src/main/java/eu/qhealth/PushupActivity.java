...
public class PushupActivity extends FragmentActivity implements PushupFragment.ExerciseListener {
    User user;
    Exercises ex;
    ...
    @Override
    public float result() {
        PushupFragment f = (PushupFragment) getFragmentManager().findFragmentById(R.id.fragment1);
        return f.result();
    }
