...
public class ExerciseAdapter extends BaseExpandableListAdapter {
    ...
    public ExerciseAdapter(Context context, ArrayList<Exercises> values) {
    ...
    public Object getChild(int listPosition, int expandedListPosition) {
        return this.values.get(listPosition).getDescription();
    }
    ...
    public Object getGroup(int listPosition) {
        return this.values.get(listPosition).getType();
    }
